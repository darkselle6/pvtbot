...
SUP_BUTTONS = [
    [
        Button.url("• Telegram •", url="t.me/shadowdemon_xd"),
        Button.url("• Support •", url="t.me/shadowdemon_xd"),
    ],
    [
...
HELP_BUTTONS = [
    [
        Button.url("• Owner •", url="https://t.me/shadowdemon_xd"),
        Button.url("• Support •", url="https://t.me/shadowdemon_xd"),
    ],
]
        ...
        result = await event.builder.article(
            ...
            buttons=[
                [
                    ...
                    Button.url("Channel", url="t.me/shadowdemon_xd"),
                ],
            ],
        )
        await event.answer([result])
